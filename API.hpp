...
String CrearRegistro(double lat, double lng, float tds, float temperature, float conductivity, float pH, String Token)
{
  HTTPClient http;
...
// en api // en arduino
  authRequest["categoria"] = "agua";
  authRequest["tiempo"] = "";
  authRequest["tds"] = tds;
  authRequest["temperatura"] = temperature;
  authRequest["conductividad"] = conductivity;
  authRequest["ph"] = pH;
